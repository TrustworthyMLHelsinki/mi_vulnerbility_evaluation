...
def main():
    ...
    parser.add_argument("--dataset", required=True, help="Dataset name used in the output directory structure.")
    ...
    if args.eval_sample_size > N_superset_max_size:
        raise ValueError("eval_sample_size cannot exceed the largest finite frame.")

    # Sample one maximum frame. All smaller frames are nested inside it.
    ...
    # The LOO script excludes the current target from this pool before sampling.
